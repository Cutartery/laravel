        ...
        <table class="table table-striped table-bordered table-hover" id="sample-table">
          ...
          <tbody>
            ...
            <tr>
              <td width="25px"><label><input type="checkbox" class="ace"><span class="lbl"></span></label></td>
              <td width="80px">45631</td>
              <td width="250px"><u style="cursor:pointer" class="text-primary" onclick="">玉兰油 Olay 新生塑颜金纯面霜轻盈无香精型50g
                  (大红瓶抗皱紧致 补水保湿) </u></td>
              <td width="100px">5467</td>
              <td width="100px">4525</td>
              <td width="100px">法国</td>
            ...
            <tr>
              <td width="25px"><label><input type="checkbox" class="ace"><span class="lbl"></span></label></td>
              <td width="80px">45631</td>
              <td width="250px"><u style="cursor:pointer" class="text-primary" onclick="">玉兰油 Olay 多效修护霜50g(乳液面霜 补水保湿
                  提拉紧致) </u></td>
              <td width="100px">5467</td>
              <td width="100px">4525</td>
              <td width="100px">法国</td>
            ...
            <tr>
              ...
              <td width="250px"><u style="cursor:pointer" class="text-primary" onclick="">Olay玉兰油 多效修护粉嫩气色霜50g（保养级BB霜
                  裸妆） 4G手机Y</u></td>
              <td width="100px">5467</td>
              <td width="100px">4525</td>
              <td width="100px">法国</td>
            ...
            <tr>
              ...
              <td width="250px"><u style="cursor:pointer" class="text-primary" onclick="">Olay玉兰油 多效修护润舒霜50g（补水保湿、细腻肌肤）
                </u></td>
              <td width="100px">5467</td>
              <td width="100px">4525</td>
              <td width="100px">法国</td>
            ...
            <tr>
              ...
              <td width="250px"><u style="cursor:pointer" class="text-primary" onclick="">Olay玉兰油 水感透白亮肤凝乳75ml（提亮肤色）
                </u></td>
              <td width="100px">5467</td>
              <td width="100px">4525</td>
              <td width="100px">法国</td>
            ...
            <tr>
              ...
              <td width="250px"><u style="cursor:pointer" class="text-primary" onclick="">Olay玉兰油 白里透红嫩白乳液75ml（保湿 滋润)
                  4G手机Y</u></td>
              <td width="100px">5467</td>
              <td width="100px">4525</td>
              <td width="100px">法国</td>
            ...
            <tr>
              ...
              <td width="250px"><u style="cursor:pointer" class="text-primary" onclick="">小米 Max 全网通 高配版 3GB内存 64GB ROM
                  金色 移动联通电信4G手机Y</u></td>
              <td width="100px">5467</td>
              <td width="100px">4525</td>
              <td width="100px">法国</td>
