                    ...
                    <table class="table table-striped table-bordered table-hover" id="sample-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td width="50px">
                                    <input type="text" value="{{$v->id}}" style="width:60px">
                                </td>
                                <td>
                                    <img src="{{$v->brand_logo}}" width="130" />
                                </td>
                                <td>
                                    <a href="javascript:ovid()" name="{{route('Brand_detailed')}}" style="cursor:pointer" class="text-primary brond_name" onclick="generateOrders('561');" title="{{$v->brand_name}}">{{$v->brand_name}}</a>
                                </td>
                                <td class="text-l">{{$v->brand_content}}</td>
                                <td>{{$v->created_at}}</td>
                                <td>{{$v->updated_at}}</td>
                                <td class="td-status">
