                    ...
                    <table class="table table-striped table-bordered table-hover" id="sample-table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><a href="javascript:ovid()" name="{{route('Brand_detailed')}}" style="cursor:pointer" class="text-primary brond_name"
                            ...
                            <tr>
                                ...
                                <td><u style="cursor:pointer" class="text-primary brond_name" onclick="member_show('张三','{{route('member_show')}}','10001','360','400')">薇姿</u></td>
                                <td>法国</td>
                                <td class="text-l">玉兰油OLAY，是宝洁公司全球著名的护肤品牌，OLAY以全球高科技护肤研发技术为后盾......</td>
                                <td>2014-6-11 11:11:42</td>
                                <td class="td-status"><span class="label label-success radius">已启用</span></td>
                            ...
                            <tr>
                                ...
                                <td><u style="cursor:pointer" class="text-primary brond_name" onclick="member_show('张三','{{route('member_show')}}','10001','360','400')">丝塔芙</u></td>
                                <td>法国</td>
                                <td class="text-l">玉兰油OLAY，是宝洁公司全球著名的护肤品牌，OLAY以全球高科技护肤研发技术为后盾......</td>
                                <td>2014-6-11 11:11:42</td>
                                <td class="td-status"><span class="label label-success radius">已启用</span></td>
                            ...
                            <tr>
                                ...
                                <td><u style="cursor:pointer" class="text-primary brond_name" onclick="member_show('张三','{{route('member_show')}}','10001','360','400')">比克度</u></td>
                                <td>法国</td>
                                <td class="text-l">玉兰油OLAY，是宝洁公司全球著名的护肤品牌，OLAY以全球高科技护肤研发技术为后盾......</td>
                                <td>2014-6-11 11:11:42</td>
                                <td class="td-status"><span class="label label-success radius">已启用</span></td>
...
<script>
    ...
    function generateOrders(id) {
        window.location.href = "{{route('Brand_detailed')}}?=" + id;
    };
    /*品牌-查看*/
