...
<body>
    <div class="page-content clearfix">
        ...
        <div class="clearfix">
            <div class="home_btn">
                <div>
                    <a href="{{route('picture_add')}}" title="添加商品" class="btn  btn-info btn-sm no-radius">
                        <i class="bigger-200"><img src="images/icon-addp.png" /></i>
                        <h5 class="margin-top">添加商品</h5>
                    </a>
                    <a href="{{route('Category_Manage')}}" title="产品分类" class="btn  btn-primary btn-sm no-radius">
                    ...
                    <a href="{{route('Systems')}}" title="系统设置" class="btn  btn-info btn-sm no-radius">
                        <i class="bigger-200"><img src="images/xtsz.png" /></i>
                        <h5 class="margin-top">系统设置</h5>
                    </a>
                    <a href="{{route('Order_handling')}}" title="商品订单" class="btn  btn-purple btn-sm no-radius">
                        <i class="bigger-200"><img src="images/icon-gwcc.png" /></i>
                        <h5 class="margin-top">商品订单</h5>
                    </a>
                    <a href="{{route('picture_add')}}" title="添加广告" class="btn  btn-pink btn-sm no-radius">
                        <i class="bigger-200"><img src="images/icon-ad.png" /></i>
                        <h5 class="margin-top">添加广告</h5>
                    </a>
                    <a href="{{route('article_add')}}" title="添加文章" class="btn  btn-info btn-sm no-radius">
