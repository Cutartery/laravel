					...
					<tbody>
						<tr>
							...
							<td class="td-manage">
								...
								<a href="javascript:ovid()" name="{{route('Ads_list')}}" class="btn btn-xs btn-pink ads_link" onclick="AdlistOrders('561');"
								 title="幻灯片广告列表"><i class="fa  fa-bars  bigger-120"></i></a>
							</td>
						</tr>
					</tbody>
				</table>
		...
		<div class="">
			<ul>
				...
				<li><label class="label_name">分类说明</label>
					<div class="col-sm-9"><textarea name="分类说明" class="form-control" id="form-field-8" placeholder="" onkeyup="checkLength(this);"></textarea><span
						 class="wordage">剩余字数：<span id="sy" style="color:Red;">200</span>字</span></div>
				</li>
				<li><label class="label_name">分类状态</label>
					<span class="add_content"> &nbsp;&nbsp;<label><input name="form-field-radio1" type="radio" checked="checked" class="ace"><span
...
<script type="text/javascript">
	...
	function AdlistOrders(id) {
		window.location.href = "{{route('Ads_list')}}?=" + id;
	};
</script>
<script type="text/javascript">
	jQuery(function ($) {
