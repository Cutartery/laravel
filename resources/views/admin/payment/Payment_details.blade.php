        ...
        <div class="bank_list clearfix">
          <ul class="bank_logo clearfix">
            <li>
              ...
              <label><input name="form-field-checkbox" type="checkbox" class="ace"><span class="lbl"><img src="products/black/black1.png"
                    width="160px;" /></span></label>
            </li>
            <li>
              <div class="delete_bank"><a href="javascript:ovid()" onclick="bank_del(this,'124')" class="fa fa-remove"></a></div>
              <label><input name="form-field-checkbox" type="checkbox" class="ace"><span class="lbl"><img src="products/black/black2.png"
                    width="160px;" /></span></label>
            </li>
            <li>
              <div class="delete_bank"><a href="javascript:ovid()" onclick="bank_del(this,'125')" class="fa fa-remove"></a></div>
              <label><input name="form-field-checkbox" type="checkbox" class="ace"><span class="lbl"><img src="products/black/black3.png"
                    width="160px;" /></span></label>
            </li>
            <li>
              <div class="delete_bank"><a href="javascript:ovid()" onclick="bank_del(this,'126')" class="fa fa-remove"></a></div>
              <label><input name="form-field-checkbox" type="checkbox" class="ace"><span class="lbl"><img src="products/black/black4.png"
                    width="160px;" /></span></label>
            </li>
            <li>
              <div class="delete_bank"><a href="javascript:ovid()" onclick="bank_del(this,'127')" class="fa fa-remove"></a></div>
              <label><input name="form-field-checkbox" type="checkbox" class="ace"><span class="lbl"><img src="products/black/black5.png"
                    width="160px;" /></span></label>
            </li>
            <li><label><input name="form-field-checkbox" type="checkbox" class="ace"><span class="lbl"><img src="products/black/black6.png"
                    width="160px;" /></span></label></li>
            <li><label><input name="form-field-checkbox" type="checkbox" class="ace"><span class="lbl"><img src="products/black/black7.png"
                    width="160px;" /></span></label></li>
            <li><label><input name="form-field-checkbox" type="checkbox" class="ace"><span class="lbl"><img src="products/black/black8.png"
                    width="160px;" /></span></label></li>
            <li><label><input name="form-field-checkbox" type="checkbox" class="ace"><span class="lbl"><img src="products/black/black9.png"
                    width="160px;" /></span></label></li>
            <li><label><input name="form-field-checkbox" type="checkbox" class="ace"><span class="lbl"><img src="products/black/black10.png"
                    width="160px;" /></span></label></li>
            <li><label><input name="form-field-checkbox" type="checkbox" class="ace"><span class="lbl"><img src="products/black/black11.png"
                    width="160px;" /></span></label></li>
            <li><label><input name="form-field-checkbox" type="checkbox" class="ace"><span class="lbl"><img src="products/black/black12.png"
                    width="160px;" /></span></label></li>
            <li><label><input name="form-field-checkbox" type="checkbox" class="ace"><span class="lbl"><img src="products/black/black13.png"
                    width="160px;" /></span></label></li>
            <li><label><input name="form-field-checkbox" type="checkbox" class="ace"><span class="lbl"><img src="products/black/black14.png"
                    width="160px;" /></span></label></li>
            <li><label><input name="form-field-checkbox" type="checkbox" class="ace"><span class="lbl"><img src="products/black/black15.png"
                    width="160px;" /></span></label></li>
          </ul>
