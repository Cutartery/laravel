            ...
            <div class="defray_list cover_style clearfix">
                ...
                <div class="defray_content clearfix">
                    ...
                    <ul class="defray_info">
                        ...
                        <li class="select">
                            <label><input name="form-field-radio1" type="radio" class="ace" checked="checked"><span
                                    class="lbl">启用</span></label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <ul class="defray_info">
                        ...
                        <li class="name_logo"><img src="products/black/yinglian.jpg" width="100%" height="150px;" />
                        </li>
                        <li class="description">中国银联是中国银行卡联合组织，通过银联跨行交易清算系统，实现商业银行系统间的互联互通和资源共享，保证银行卡跨行、跨地区和跨境的使用。</li>
                        <li class="select">
                            <label><input name="form-field-radio2" type="radio" class="ace" checked="checked"><span
                                    class="lbl">启用</span></label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <label><input name="form-field-radio2" type="radio" class="ace"><span class="lbl">关闭</span></label>
                        </li>
                        <li class="operating">
                            <a href="javascript:ovid()" class="btn btn-danger"><i class="fa fa-trash"></i>&nbsp;删除</a>
                            <a href="javascript:ovid()" name="{{route('Payment_details')}}" title="银联支付详细" onclick="Paymentdetails('134')"
                                class="btn btn-success details_btn"><i class="fa  fa-newspaper-o "></i>&nbsp;详细</a>
                        </li>
                    </ul>
                    <ul class="defray_info">
                        ...
                        <li class="description">中国银联是中国银行卡联合组织，通过银联跨行交易清算系统，实现商业银行系统间的互联互通和资源共享，保证银行卡跨行、跨地区和跨境的使用。</li>
                        <li class="select">
                            <label><input name="form-field-radio3" type="radio" class="ace" checked="checked"><span
                                    class="lbl">启用</span></label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <label><input name="form-field-radio3" type="radio" class="ace"><span class="lbl">关闭</span></label>
                        </li>
                        <li class="operating">
                            <a href="javascript:ovid()" class="btn btn-danger"><i class="fa fa-trash"></i>&nbsp;删除</a>
                            <!-- <a href="javascript:ovid()" name="{{route('Payment_details')}}" title="怡宝支付详细" onclick="Paymentdetails('234')" class="btn btn-success details_btn"><i class="fa  fa-newspaper-o "></i>&nbsp;详细</a>-->
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <div id="add_payment_style" style="display:none">
        <form id="payment_checkbox">
            <ul class="margin payment_list  clearfix">
                <li>
                    <label><input name="checkbox" type="checkbox" class="ace" id="checkbox" onclick="select_payment(this,'123')"><span
                            class="lbl"><img src="products/black/yinglian.jpg" width="120px" height="100%" /> </span></label>
                </li>
                <li>
                    <label><input name="checkbox" type="checkbox" class="ace" id="checkbox" onclick="select_payment(this,'125')"><span
                            class="lbl"><img src="products/black/yozhif.jpg" width="120px" height="100%" /></label>
                </li>
                <li>
                    <label><input name="checkbox" type="checkbox" class="ace" id="checkbox" onclick="select_payment(this,'126')"><span
                            class="lbl"><img src="products/black/caifut.jpg" width="120px" height="100%" /></label>
                </li>
                <li>
                    <label><input name="checkbox" type="checkbox" class="ace" id="checkbox" onclick="select_payment(this,'127')"><span
                            class="lbl"><img src="products/black/weixin.jpg" width="120px" height="100%" /></label>
                </li>
                <li>
                    <label><input name="checkbox" type="checkbox" class="ace" id="checkbox" onclick="select_payment(this,'127')"><span
                            class="lbl"><img src="products/black/zhifb.jpg" width="120px" height="100%" /></label>
                </li>
            </ul>
            <div class="add_content clearfix">
                <ul>
                    ...
                    <li class=" clearfix"><label class="label_name">排序</label><span><input name="" type="text" value="0"
                                style="width:80px;" /></span></li>
                    <li class=" clearfix"><label class="label_name">说明</label><span><textarea name="说明" class="form-textarea"
                                id="form_textarea" placeholder="" onkeyup="checkLength(this);"></textarea><span style=" margin-left:10px;">剩余字数：<em
                                    id="sy" style="color:Red;">200</em>字</span></span></li>
                </ul>
            </div>
        </form>
    </div>
...
<script>
    ...
    function Paymentdetails(id) {
        window.location.href = "{{route('Payment_details')}}?=" + id;
    };
