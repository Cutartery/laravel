        ...
        <div class="cover_style" id="cover_style">
            <div class="search_style">
                ...
                <ul class="search_content clearfix">
                    <li><label class="l_f">用户</label><input name="" type="text" class="text_add" placeholder="用户名称"
                ...
                <table class="table table-striped table-bordered table-hover" id="sample-table">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="td-manage">
                                <a onClick="member_stop(this,'10001')" href="javascript:;" title="启用" class="btn btn-xs btn-success"><i
                                        class="fa fa-check  bigger-120"></i></a>
                                <a href="javascript:ovid()" name="{{route('Account_Details')}}" class="btn btn-xs  btn-warning Account_Details"
                                    onclick="generateOrders('511');" title="张奶奶账户详细">
                        ...
                        <tr>
                            ...
                            <td class="td-manage">
                                <a onClick="member_stop(this,'10001')" href="javascript:;" title="启用" class="btn btn-xs btn-success"><i
                                        class="fa fa-check  bigger-120"></i></a>
                                <a href="javascript:ovid()" name="{{route('Account_Details')}}" class="btn btn-xs  btn-warning Account_Details"
                                    onclick="generateOrders('561');" title="张小泉账户详细">
                                    <i class="fa fa-list-ul bigger-120"></i></a>
                            </td>
                        </tr>
                    </tbody>
...
<script type="text/javascript">
    ...
    function generateOrders(id) {
        window.location.href = "{{route('Account_Details')}}?=" + id;
    };
</script>