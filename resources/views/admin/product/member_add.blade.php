...
<body>
    <div class="clearfix" id="add_picture">
        ...
        <div class="page_right_style">
            ...
            <form action="{{route('domember_add',['id'=>$data['id']])}}" method="post" enctype="multipart/form-data" class="form form-horizontal" id="form-article-add">
                @csrf
                <div class="clearfix cl">
                    <label class="form-label col-2"><span class="c-red">*</span>图片标题：</label>
                    <div class="formControls col-10"><input type="text" class="input-text" value="{{$data->img_title}}" placeholder="" id=""
                            name="img_title"></div>
                </div>
                <div class=" clearfix cl">
                    <label class="form-label col-2">简略标题：</label>
                    <div class="formControls col-10"><input type="text" class="input-text" value="{{$data->titles}}" placeholder="" id=""
                            name="titles"></div>
                </div>
                <div class=" clearfix cl">
                    ...
                    <div class="Add_p_s">
                        ...
                        <div class="formControls col-2"><input type="text" class="input-text" value="{{$data->number}}" placeholder=""
                                id="" name="number"></div>
                    </div>
                    <div class="Add_p_s">
                        <label class="form-label col-2">产&nbsp;&nbsp;&nbsp;&nbsp;地：</label>
                        <div class="formControls col-2"><input type="text" class="input-text" value="{{$data->place}}" placeholder=""
                                id="" name="place"></div>
                    </div>
                    <div class="Add_p_s">
                        <label class="form-label col-2">材&nbsp;&nbsp;&nbsp;&nbsp;质：</label>
                        <div class="formControls col-2"><input type="text" class="input-text" value="{{$data->material}}" placeholder=""
                                id="" name="material"></div>
                    </div>
                    <div class="Add_p_s">
                        <label class="form-label col-2">品&nbsp;&nbsp;&nbsp;&nbsp;牌：</label>
                        <div class="formControls col-2"><input type="text" class="input-text" value="{{$data->brand}}" placeholder=""
                                id="" name="brand"></div>
                    </div>
                    <div class="Add_p_s">
                    ...
                    <div class="Add_p_s">
                        ...
                        <div class="formControls col-2"><input type="text" class="input-text" value="{{$data->zprice}}" placeholder=""
                                id="" name="zprice">元</div>
                    </div>
                    <div class="Add_p_s">
                        <label class="form-label col-2">市场价格：</label>
                        <div class="formControls col-2"><input type="text" class="input-text" value="{{$data->sprice}}" placeholder=""
                ...
                <div class="clearfix cl">
                    ...
                    <div class="formControls col-10">
                        <textarea name="content" cols="" rows="" class="textarea" placeholder="说点什么...最少输入10个字符" datatype="*10-100"
                            dragonfly="true" nullmsg="备注不能为空！" onKeyUp="textarealength(this,200)">{{$data->content}}</textarea>
                        <p class="textarea-numberbar"><em class="textarea-length">0</em>/200</p>
                    </div>
                </div>
                <input type="hidden" name="img" value="{{$data->file}}">
                <input type="hidden" name="id" value="{{$data->id}}">

                <div class="clearfix cl">
                    <label class="form-label col-2">图片上传：</label>
                    <div class='img_preview'>
                    <img src="{{$data->file}}" width="150" alt="">
                    </div>
                    <input class="image" type="file" name="file" id="">
                </div>
                <div class="clearfix cl">
                    <label class="form-label col-2">详细内容：</label>
                    <div class="formControls col-10">
                        <script id="editor" name="scontent" type="text/plain" style="width:100%;height:400px;">{!!$data->scontent!!}</script>
                    </div>
                </div>
                <div class="clearfix cl">
