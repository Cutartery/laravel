				...
				<div class="py-container">
					<div class="shortcut">
						<ul class="fl">
							...
							<li class="f-item">请<a href="{{route('goods_login')}}" target="_blank">登录</a>　<span><a href="{{route('goods_register')}}" target="_blank">免费注册</a></span></li>
						</ul>
						<ul class="fr">
						...
						<div class="yui3-u Right shopArea">
							<div class="fr shopcar">
								<div class="show-shopcar" id="shopcar">
									<span class="car"></span>
									<a class="sui-btn btn-default btn-xlarge" href="{{route('goods_cart')}}" target="_blank">
										<span>我的购物车</span>
										<i class="shopnum">0</i>
									</a>
		...
		<div class="py-container">
			<ul class="yui3-g Recommend">
				...
				<li class="yui3-u-5-24">
					<a href="{{route('goods_item')}}" target="_blank"><img src="img/today01.png" /></a>
				</li>
				<li class="yui3-u-5-24">
